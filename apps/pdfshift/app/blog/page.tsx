...
export const metadata = {
  title: 'PDFShift Blog — PDF tools',
  description: 'PDF convert, merge, and split tips.',
};
...
export default async function BlogIndex() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-16">
      <h1 className="text-3xl font-bold text-slate-900">PDFShift Blog</h1>
      <p className="mt-2 text-slate-600">PDF tools that just work.</p>
