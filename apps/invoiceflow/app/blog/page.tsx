...
export const metadata = {
  title: 'InvoiceFlow Blog — Invoicing tips for freelancers',
  description: 'Practical invoicing, payments, and freelance finance tips.',
};
...
export default async function BlogIndex() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-16">
      <h1 className="text-3xl font-bold text-slate-900">InvoiceFlow Blog</h1>
      <p className="mt-2 text-slate-600">Invoicing tips that actually get you paid.</p>
