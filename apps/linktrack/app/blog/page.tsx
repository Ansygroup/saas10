...
export const metadata = {
  title: 'LinkTrack Blog — Link tracking for marketers',
  description: 'UTM tags, click tracking, and link analytics explained simply.',
};
...
export default async function BlogIndex() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-16">
      <h1 className="text-3xl font-bold text-slate-900">LinkTrack Blog</h1>
      <p className="mt-2 text-slate-600">Track every link you share.</p>
